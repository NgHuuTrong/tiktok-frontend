export const ClearIcon = ({ className, height = '1.6rem', width = '1.6rem' }) => (
  <svg
    className={className}
    width={width}
    data-e2e=""
...
export const LoadingIcon = ({ className, height = '1.6rem', width = '1.6rem' }) => (
  <svg
    className={className}
    width={width}
    data-e2e=""
...
export const SearchIcon = ({ className, height = '2.4rem', width = '2.4rem' }) => (
  <svg
    className={className}
    width={width}
    data-e2e=""
...
export const TickIcon = ({ className, height = '1.4rem', width = '1.4rem' }) => (
  <svg
    className={className}
    width={width}
    data-e2e=""
...
export const MoreIcon = ({ className, height = '2rem', width = '2rem' }) => (
  <svg
    className={className}
    width={width}
    data-e2e=""
